...
function resolveAutoGeneratedFlag(field: FieldInstance): boolean {
  return Boolean((field as any).isAutoGenerated ?? (field as any).isAutoGenerate ?? (field as any).is_auto_generated ?? false);
}
...
function isStrictlyAutoGeneratedField(field: FieldInstance): boolean {
  ...
  return resolveAutoGeneratedFlag(field);
}
