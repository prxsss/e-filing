      ...
      <div class="p-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            <div class="text-red-500 text-xs mt-1" v-if="templateNameError">
              {{ templateNameError }}
            </div>
          </div>
          <div>
      ...
      <div class="col-span-12 lg:col-span-8">
        ...
        <div v-else class="bg-white rounded-lg shadow-sm overflow-hidden">
          <div class="p-20 text-center">
            ...
            <p class="text-gray-500">Upload a file to start</p>
          </div>
        </div>
      </div>
...
async function fetchContracts() {
  ...
  console.log("Using mock contracts data - database fetch disabled");
  return;
