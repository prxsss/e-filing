...
export default defineEventHandler(async (event: H3Event) => {
  ...
  try {
    ...
    const mappedField = {
      ...
      dropdownConfig: serializeDropdownConfig(updatedField.dropdownConfig),
      dropdown_config: serializeDropdownConfig(updatedField.dropdownConfig),
      ...
      ...(updatedField.dateFormatConfig && typeof updatedField.dateFormatConfig === 'object' ? updatedField.dateFormatConfig : {}),
    };
