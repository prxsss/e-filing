  ...
  try {
    ...
    const data = await db
      .select({
        ...
        requesterNameTh: sql<string>`CONCAT(${users.firstNameTh}, ' ', ${users.lastNameTh})`,
        studentId: users.id,
        studentNameEn: sql<string>`CONCAT(${users.firstNameEn}, ' ', ${users.lastNameEn})`,
        studentNameTh: sql<string>`CONCAT(${users.firstNameTh}, ' ', ${users.lastNameTh})`,
