...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const fieldsWithValues = placedFields.map((field: any) => {
      ...
      const autoGeneratedValue = applyFieldCharacterLimit(resolveAutoGeneratedFieldValue(field), field).trim();
      const fieldValue = manualFieldValue || autoGeneratedValue;
      return {
        ...field,
...
function formatCurrentDateValue(): string {
...
function formatCurrentTimeValue(): string {
  return new Intl.DateTimeFormat('en-GB', {
    hour: '2-digit',
    minute: '2-digit',
    hour12: false,
